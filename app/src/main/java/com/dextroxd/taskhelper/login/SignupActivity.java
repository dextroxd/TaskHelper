...
public class SignupActivity extends AppCompatActivity {
    ...
    private String uid,email,phone,password,address,name;
    public String id;
    private TextView btnResetPassword,btnSkip,btnSignIn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"You must enter the name",Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    add_User();
                                    Intent in =new Intent(SignupActivity.this, VerificationActivity.class);
    ...
    {
        address="";
        id = database_Users.push().getKey();
        uid = auth.getCurrentUser().getUid();
        progressBar.setVisibility(View.VISIBLE);
        User user = new User(name,phone,address,email,0);
        database_Users.child(uid).setValue(user).addOnCompleteListener(SignupActivity.this, new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                Toast.makeText(SignupActivity.this,"User added",Toast.LENGTH_SHORT).show();
                if(!task.isSuccessful())
                {
                    Toast.makeText(getApplicationContext(),"User is not added! please check your connection",Toast.LENGTH_SHORT).show();
                    return;
                }
